...
export function getPageSEO(page: 'home' | 'gewerbestrom' | 'gewerbegas' | 'stromvergleich' | 'gasvergleich' | 'photovoltaik' | 'kontakt' | 'ratgeber' | 'datenschutz' | 'impressum' | 'methodik') {
  ...
  const pageConfigs = {
    ...
    stromvergleich: {
      title: 'Stromvergleich NRW 2026 | Ab 27 ct/kWh – Stromanbieter jetzt wechseln',
      description: 'Stromanbieter in NRW vergleichen: Ø 29–33 ct/kWh Arbeitspreis – günstige Tarife ab 27 ct/kWh für Köln, Düsseldorf, Dortmund & ganz NRW. Kostenloser Live-Rechner, in 3 Min. fertig.',
      keywords: 'Stromvergleich NRW 2026, Stromanbieter wechseln NRW, günstige Stromtarife NRW, Strom sparen NRW, bester Stromanbieter NRW, Strompreis NRW 2026',
      ogTitle: 'Stromvergleich NRW 2026 | Stromanbieter wechseln & bis zu 400 € sparen',
      ogDescription: 'Günstige Stromanbieter in NRW: Tarife ab 27 ct/kWh, kostenloser Live-Vergleich für Köln, Düsseldorf, Dortmund und ganz NRW.',
    },
    gasvergleich: {
      title: 'Gasvergleich NRW 2026 | Ab 9 ct/kWh – Gasanbieter jetzt wechseln',
      description: 'Gasanbieter in NRW vergleichen: Ø 10–11 ct/kWh Arbeitspreis – günstige Gastarife ab 9 ct/kWh für Köln, Düsseldorf, Dortmund & ganz NRW. Kostenloser Live-Rechner, sofort online.',
      keywords: 'Gasvergleich NRW 2026, Gasanbieter wechseln NRW, günstige Gastarife NRW, Gas sparen NRW, bester Gasanbieter NRW, Gaspreis NRW 2026',
      ogTitle: 'Gasvergleich NRW 2026 | Gasanbieter wechseln & Kosten senken',
      ogDescription: 'Günstige Gasanbieter in NRW: Tarife ab 9 ct/kWh, kostenloser Live-Vergleich für Köln, Düsseldorf, Dortmund und ganz NRW.',
    },
    photovoltaik: {
