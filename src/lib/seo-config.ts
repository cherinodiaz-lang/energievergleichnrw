...
export const SEO_CONFIG = {
  ...
  siteDescription:
    'Vergleichen Sie Strom- und Gastarife in Nordrhein-Westfalen. Finden Sie passende Angebote für Privat- und Gewerbekunden. Kostenlos und unabhängig.',
  ...
  keywords: {
    ...
    gewerbestrom:
      'Gewerbestrom NRW, Stromtarife Unternehmen, Gewerbekunden, Stromvergleich Gewerbe',
...
export function getPageSEO(
  ...
  const pageConfigs = {
    home: {
      ...
      description:
        'Stromvergleich & Gasvergleich für NRW: Tarife vergleichen, sparen und bequem wechseln. Kostenlos, unabhängig und transparent – auch für Gewerbe.',
      keywords: SEO_CONFIG.keywords.home,
      ogTitle: 'Strom & Gas vergleichen in NRW | Energievergleich',
      ogDescription:
        'Strom- und Gastarife in NRW vergleichen, sparen und bequem wechseln. Kostenlos und unabhängig.',
    },
    stromvergleich: {
      title: 'Stromvergleich NRW | Stromtarife vergleichen & sparen',
      description:
        'Stromtarife in NRW vergleichen: passende Angebote finden, Kosten senken und unkompliziert wechseln. Kostenloser Vergleich inkl. Tipps & Ratgeber.',
      keywords:
        'Stromvergleich NRW, Stromtarife, günstige Stromangebote, Strom sparen, Stromanbieter wechseln',
    ...
    gasvergleich: {
      ...
      description:
        'Gastarife in NRW vergleichen: Tarife prüfen, Kosten senken und einfach wechseln. Kostenloser Vergleich inkl. Tipps zu Laufzeit & Preisgarantie.',
      keywords:
        'Gasvergleich NRW, Gastarife, günstige Gasangebote, Gas sparen, Gasanbieter wechseln',
    ...
    photovoltaik: {
      ...
      description:
        'Photovoltaik in NRW: Infos zu Kosten, Förderung, Einspeisevergütung und Planung. Kostenloser Ratgeber + Anfrage für Beratung.',
      keywords:
        'Photovoltaik NRW, Solaranlage, PV-Anlage, Solarförderung, Einspeisevergütung, Solarkosten',
    ...
    'stromvergleich-essen': {
      ...
      description:
        'Stromtarife in Essen vergleichen: passende Angebote finden, Kosten senken und unkompliziert wechseln. Kostenlos & unabhängig – inkl. Tipps.',
      keywords:
        'Stromvergleich Essen, Stromtarife Essen, Stromanbieter Essen, Strom sparen Essen, Strom wechseln Essen',
    ...
    'stromvergleich-bochum': {
      ...
      description:
        'Stromtarife in Bochum vergleichen: passende Angebote finden, Kosten senken und unkompliziert wechseln. Kostenlos & unabhängig – inkl. Tipps.',
      keywords:
        'Stromvergleich Bochum, Stromtarife Bochum, Stromanbieter Bochum, Strom sparen Bochum, Strom wechseln Bochum',
    ...
    'stromvergleich-duisburg': {
      ...
      description:
        'Stromtarife in Duisburg vergleichen: passende Angebote finden, Kosten senken und unkompliziert wechseln. Kostenlos & unabhängig – inkl. Tipps.',
      keywords:
        'Stromvergleich Duisburg, Stromtarife Duisburg, Stromanbieter Duisburg, Strom sparen Duisburg, Strom wechseln Duisburg',
    ...
    'stromvergleich-koeln': {
      ...
      description:
        'Stromtarife in Köln vergleichen: passende Angebote finden, Kosten senken und unkompliziert wechseln. Kostenlos & unabhängig – inkl. Tipps.',
      keywords:
        'Stromvergleich Köln, Stromtarife Köln, Stromanbieter Köln, Strom sparen Köln, Strom wechseln Köln',
    ...
    'stromvergleich-duesseldorf': {
      ...
      description:
        'Stromtarife in Düsseldorf vergleichen: passende Angebote finden, Kosten senken und unkompliziert wechseln. Kostenlos & unabhängig – inkl. Tipps.',
      keywords:
        'Stromvergleich Düsseldorf, Stromtarife Düsseldorf, Stromanbieter Düsseldorf, Strom sparen Düsseldorf, Strom wechseln Düsseldorf',
    ...
    'stromvergleich-dortmund': {
      ...
      description:
        'Stromtarife in Dortmund vergleichen: passende Angebote finden, Kosten senken und unkompliziert wechseln. Kostenlos & unabhängig – inkl. Tipps.',
      keywords:
        'Stromvergleich Dortmund, Stromtarife Dortmund, Stromanbieter Dortmund, Strom sparen Dortmund, Strom wechseln Dortmund',
    ...
    'stromvergleich-wuppertal': {
      ...
      description:
        'Stromtarife in Wuppertal vergleichen: passende Angebote finden, Kosten senken und unkompliziert wechseln. Kostenlos & unabhängig – inkl. Tipps.',
      keywords:
        'Stromvergleich Wuppertal, Stromtarife Wuppertal, Stromanbieter Wuppertal, Strom sparen Wuppertal, Strom wechseln Wuppertal',
    ...
    'stromvergleich-bielefeld': {
      ...
      description:
        'Stromtarife in Bielefeld vergleichen: passende Angebote finden, Kosten senken und unkompliziert wechseln. Kostenlos & unabhängig – inkl. Tipps.',
      keywords:
        'Stromvergleich Bielefeld, Stromtarife Bielefeld, Stromanbieter Bielefeld, Strom sparen Bielefeld, Strom wechseln Bielefeld',
    ...
    'stromvergleich-bonn': {
      ...
      description:
        'Stromtarife in Bonn vergleichen: passende Angebote finden, Kosten senken und unkompliziert wechseln. Kostenlos & unabhängig – inkl. Tipps.',
      keywords:
        'Stromvergleich Bonn, Stromtarife Bonn, Stromanbieter Bonn, Strom sparen Bonn, Strom wechseln Bonn',
    ...
    'stromvergleich-muenster': {
      ...
      description:
        'Stromtarife in Münster vergleichen: passende Angebote finden, Kosten senken und unkompliziert wechseln. Kostenlos & unabhängig – inkl. Tipps.',
      keywords:
        'Stromvergleich Münster, Stromtarife Münster, Stromanbieter Münster, Strom sparen Münster, Strom wechseln Münster',
    ...
    gewerbestrom: {
      ...
      description:
        'Gewerbestrom in NRW: Tarife für Unternehmen vergleichen und Beratung anfragen. Transparent, effizient und auf Ihren Betrieb abgestimmt.',
    ...
    gewerbegas: {
      ...
      description:
        'Gewerbegas in NRW: Tarife vergleichen, Konditionen prüfen und Beratung anfragen. Planungssicherheit für Ihren Betrieb.',
    ...
    kontakt: {
      ...
      description:
        'Kontakt: Stellen Sie Ihre Anfrage zu Strom, Gas, Gewerbeenergie oder Photovoltaik. Wir melden uns schnellstmöglich zurück.',
    ...
    ratgeber: {
      ...
      description:
        'Ratgeber und Guides zu Strom, Gas, Photovoltaik und Gewerbeenergie: Wechselwissen, Spartipps und Checklisten – verständlich erklärt.',
    ...
    datenschutz: {
      ...
      description:
        'Datenschutzerklärung: Informationen zur Verarbeitung Ihrer Daten, Cookies und Ihren Rechten nach DSGVO.',
    ...
    methodik: {
      ...
      description:
        'Methodik: So läuft unser Tarifvergleich ab – transparent, nachvollziehbar und mit klaren Kriterien.',
