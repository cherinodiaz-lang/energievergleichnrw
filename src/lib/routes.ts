...
export const ROUTES: Record<RouteKey, string> = {
  ...
  stromvergleichEssen: '/stromvergleich-essen',
...
export const NAV_MAIN: NavItem[] = [
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        key: 'ratgeberPhotovoltaik',
        label: 'Photovoltaik-Ratgeber',
        to: ROUTES.ratgeberPhotovoltaik,
      },
...
export const NAV_SECONDARY: NavItem[] = [
  ...
  {
    key: 'ratgeberWechselwissen',
    label: 'Ratgeber Wechselwissen',
    to: ROUTES.ratgeberWechselwissen,
  },
];
...
export const NAV_LEGAL: NavItem[] = [
  { key: 'ueberUns', label: 'Über uns', to: ROUTES.ueberUns },
