...
export default function PhotovoltaikNrwPage() {
  ...
  const breadcrumbSchema = [
    ...
    {
      name: 'Photovoltaik NRW',
      url: `${typeof window !== 'undefined' ? window.location.origin : ''}${ROUTES.photovoltaik}`,
    },
  ];
        ...
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="font-paragraph text-[15px] sm:text-base md:text-xl text-white/90 mb-8 max-w-2xl">
              Nutzen Sie die Kraft der Sonne und werden Sie unabhängig von steigenden Strompreisen.
          ...
          <div className="space-y-8">
            <div>
              <h2 className="font-heading text-3xl font-bold text-primary mb-6">
                Kurz erklärt: Photovoltaik-Angebotsvergleich für NRW
              </h2>

              <p className="font-paragraph text-lg text-gray-700 mb-6">
                Mit unserem kostenlosen Photovoltaik-Vergleich finden Sie in wenigen Minuten die
                beste Solaranlage für Ihr Zuhause in Nordrhein-Westfalen. Der Vergleich ist völlig
                kostenlos und unverbindlich – Sie geben nur wenige Angaben ein und erhalten sofort
                Angebote von zertifizierten Fachbetrieben. Sparen Sie bis zu 40% der
                Installationskosten durch den Vergleich mehrerer Anbieter und profitieren Sie von
                maßgeschneiderten Lösungen für Ihr Dach.
              </p>
            </div>

            <div>
              <h3 className="font-heading text-2xl font-bold text-primary mb-4">
                So funktioniert der Angebotsvergleich – 5 Schritte
              </h3>
              <ol className="font-paragraph text-gray-700 space-y-3 mb-6 list-decimal list-inside">
                <li>
                  <strong>Dachfläche und Ausrichtung angeben:</strong> Geben Sie die Größe und
                  Ausrichtung Ihres Daches ein (Süd, Ost, West)
                </li>
                <li>
                  <strong>Stromverbrauch eintragen:</strong> Tragen Sie Ihren jährlichen
                  Stromverbrauch in kWh ein (zu finden auf der Stromrechnung)
                </li>
                <li>
                  <strong>Postleitzahl und Standort:</strong> Geben Sie Ihre PLZ ein, um Angebote
                  für Ihre Region zu erhalten
                </li>
                <li>
                  <strong>Angebote vergleichen:</strong> Sehen Sie alle verfügbaren Angebote mit
                  Anlagengröße, Kosten, Ertrag und Amortisationszeit
                </li>
                <li>
                  <strong>Wunsch-Angebot wählen:</strong> Entscheiden Sie sich für den besten
                  Anbieter und erhalten Sie eine kostenlose Vor-Ort-Beratung
                </li>
              </ol>
            </div>
            ...
            <div>
              ...
              <ul className="font-paragraph text-gray-700 space-y-2 mb-6">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Dachfläche:</strong> Größe in Quadratmetern und Ausrichtung (Süd, Ost,
                    West, Nord)
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">•</span>
                  <span>
                    <strong>Postleitzahl:</strong> Bestimmt die Sonneneinstrahlung und verfügbare
                ...
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">•</span>
                  <span>
                    <strong>Stromverbrauch in kWh:</strong> Finden Sie auf Ihrer letzten
                    Stromrechnung unter „Jahresverbrauch"
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">•</span>
                  <span>
                    <strong>Fotos des Daches (optional):</strong> Helfen bei der genauen Planung und
                ...
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">•</span>
                  <span>
                    <strong>Zählernummer/Anschluss:</strong> Optional, für präzisere
                    Ertragsprognosen
                  </span>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="font-paragraph text-gray-700 space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">✓</span>
                  <span>
                    <strong>Anlagengröße:</strong> Sollte zu Ihrem Stromverbrauch passen – zu kleine
                    Anlagen nutzen Ihr Dach nicht optimal, zu große erzeugen unnötige Überschüsse
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">✓</span>
                  <span>
                    <strong>Komponentenqualität:</strong> Achten Sie auf hochwertige Module
                    (Leistungsgarantie 25+ Jahre) und zuverlässige Wechselrichter
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">✓</span>
                  <span>
                    <strong>Garantie und Gewährleistung:</strong> Mindestens 10 Jahre Gewährleistung
                    und 25 Jahre Leistungsgarantie auf Module sind Standard
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">✓</span>
                  <span>
                    <strong>Ertragsprognose:</strong> Vergleichen Sie die erwarteten Jahreserträge
                    in kWh – diese bestimmen Ihre Einsparungen
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">✓</span>
                  <span>
                    <strong>Stromspeicher-Option:</strong> Prüfen Sie, ob ein Speicher sinnvoll ist
                    – erhöht Eigennutzung und Unabhängigkeit
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">✓</span>
                  <span>
                    <strong>Finanzierungsmöglichkeiten:</strong> KfW-Kredite, Zuschüsse und
                    Eigenkapitaloptionen sollten berücksichtigt werden
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div>
              <h3 className="font-heading text-2xl font-bold text-primary mb-4">
                Häufige Fehler beim Photovoltaik-Vergleich
              </h3>
              <ul className="font-paragraph text-gray-700 space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">✗</span>
                  <span>
                    <strong>Nur auf den Preis schauen:</strong> Der günstigste Anbieter ist nicht
                    immer die beste Wahl – Qualität, Garantie und Ertragsprognose sind entscheidend
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">✗</span>
                  <span>
                    <strong>Dachfläche unterschätzen:</strong> Eine zu kleine Anlage nutzt Ihr
                    Dachpotenzial nicht aus – analysieren Sie die verfügbare Fläche genau
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">✗</span>
                  <span>
                    <strong>Förderungen ignorieren:</strong> KfW-Kredite, Zuschüsse und
                    Einspeisevergütung können die Amortisationszeit um Jahre verkürzen
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="font-paragraph text-gray-700 mb-4">
                Nordrhein-Westfalen ist mit über 18 Millionen Einwohnern das bevölkerungsreichste
                Bundesland und bietet ideale Bedingungen für Photovoltaik. Obwohl NRW nicht die
                sonnigste Region Deutschlands ist, amortisieren sich Solaranlagen durch die hohen
                Strompreise und Förderungen schnell. Die durchschnittliche Sonneneinstrahlung
                ermöglicht stabile Erträge von 900-1.000 kWh pro kWp installierter Leistung pro
                Jahr. Mit unserem Vergleich finden Sie die besten Fachbetriebe in Ihrer Stadt – ob
                in Düsseldorf, Köln, Essen, Dortmund oder einer anderen Stadt in NRW.
              </p>
            </div>

            <div className="bg-secondary/10 border-l-4 border-secondary p-6 rounded">
              <p className="font-paragraph text-gray-700 italic">
                Jetzt kostenlos Angebote anfordern und finden Sie die perfekte Solaranlage für Ihr
                Zuhause!
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                title: 'Klimaschutz',
                description:
                  'Produzieren Sie sauberen Strom und reduzieren Sie Ihren CO₂-Fußabdruck.',
              },
              {
                icon: Zap,
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg h-full">
                ...
                <p className="font-paragraph text-gray-600">
                  Wir analysieren Ihr Dach, Ihren Stromverbrauch und erstellen ein individuelles
                  Angebot.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg h-full">
                ...
                <p className="font-paragraph text-gray-600">
                  Professionelle Installation und Inbetriebnahme. Danach produzieren Sie Ihren
                  eigenen Strom.
                </p>
              </div>
            </motion.div>
        ...
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: 'Dachfläche',
                description: 'Größe und Ausrichtung Ihres Daches bestimmen die Anlagengröße.',
              },
              {
                title: 'Stromverbrauch',
                description: 'Wir dimensionieren die Anlage optimal für Ihren Bedarf.',
              },
              {
                title: 'Verschattung',
                description: 'Bäume und Gebäude können die Leistung beeinflussen.',
              },
              {
                title: 'Speicher',
                description: 'Optional: Stromspeicher für höhere Unabhängigkeit.',
              },
              {
                title: 'Förderungen',
                description: 'Wir nutzen alle verfügbaren Förderprogramme für Sie.',
              },
              {
                title: 'Qualität',
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <Label htmlFor="eigentumsart" className="font-paragraph">
                          Eigentumsart *
                        </Label>
                        <Select
                          value={formData.eigentumsart}
                          onValueChange={(value) =>
                            setFormData({ ...formData, eigentumsart: value })
                          }
                          required
                        >
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="dachform" className="font-paragraph">
                          Dachform *
                        </Label>
                        <Select
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="personen" className="font-paragraph">
                    ...
                    <div className="border-t pt-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2 md:col-span-2">
                          <Label htmlFor="strasse" className="font-paragraph">
                            Straße *
                          </Label>
                          <Input
                            id="strasse"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="hausnummer" className="font-paragraph">
                            Hausnummer *
                          </Label>
                          <Input
                            id="hausnummer"
                            ...
                            onChange={(e) =>
                              setFormData({ ...formData, hausnummer: e.target.value })
                            }
                            required
                            className="font-paragraph"
                          />
                        ...
                        <div className="space-y-2 md:col-span-2">
                          <Label htmlFor="ort" className="font-paragraph">
                            Ort *
                          </Label>
                          <Input
                            id="ort"
        ...
        <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg p-8 border border-gray-200">
            <p className="font-paragraph text-gray-700 leading-relaxed mb-6">
              Bei energievergleich.shop vergleichen wir Photovoltaik-Angebote mit vollständiger
              Transparenz und Unabhängigkeit. Wir arbeiten nicht für einzelne Anbieter, sondern für
              Sie – und das völlig kostenlos. Unser Vergleich berücksichtigt nicht nur den Preis,
              sondern auch Vertragsbedingungen, Komponenten-Qualität und Garantieleistungen. So
              finden Sie die beste Solaranlage für Ihre Situation in NRW. Alle Informationen auf
              dieser Seite sind aktuell zum Stand Februar 2026.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="h-full hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="font-paragraph text-sm text-gray-600 mb-4">
                    Vergleichen Sie Stromtarife und sparen Sie Kosten.
                  </p>
            ...
            <a href="https://www.energievergleich.shop/gasvergleich-nrw" className="group">
              <Card className="h-full hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="font-paragraph text-sm text-gray-600 mb-4">
                    Vergleichen Sie auch Ihre Gastarife.
                  </p>
                  <Button variant="outline" size="sm">
                    Mehr erfahren
                  </Button>
            ...
            <a href="https://www.energievergleich.shop/ratgeber/photovoltaik" className="group">
              <Card className="h-full hover:shadow-lg transition-shadow">
                <CardHeader>
                  <CardTitle className="font-heading text-lg group-hover:text-primary transition-colors">
                    Ratgeber: Photovoltaik verstehen
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="font-paragraph text-sm text-gray-600 mb-4">
                    Umfassender Leitfaden zu Solaranlagen.
                  </p>
                  <Button variant="outline" size="sm">
                    Mehr erfahren
                  </Button>
