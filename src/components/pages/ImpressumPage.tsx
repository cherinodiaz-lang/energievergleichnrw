          ...
          <div className="space-y-8 break-words overflow-x-hidden min-w-0">
            ...
            <div>
              <h2 className="font-heading text-2xl font-bold text-primary mb-4">
                2. Registrierung und Steuernummern
              </h2>
            ...
            <div>
              <h2 className="font-heading text-2xl font-bold text-primary mb-4">
                3. Verantwortlich i.S.d. § 18 MStV (Medienstaatsvertrag)
              </h2>

              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 space-y-4 font-paragraph text-slate-900 break-words">
                <p className="text-sm text-gray-500 mb-4">
                  Redaktionell verantwortliche Person für die Inhalte dieser Website:
                </p>
                <div>
            ...
            <div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 font-paragraph text-slate-900 break-words">
                <p className="text-sm text-gray-500 mb-4">
                  Berufsrechtliche Regelungen und Zugehörigkeiten:
                </p>
                <p>
                  Energievergleich.shop ist ein Informations- und Vergleichsportal für
                  Energieversorgung. Es unterliegen keine speziellen berufsrechtlichen Regelungen
                  für diese Tätigkeit.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="font-paragraph text-slate-900 leading-relaxed py-2">
                Die Inhalte unserer Website wurden mit größter Sorgfalt erstellt. Für die
            ...
            <div>
              ...
              <p className="font-paragraph text-slate-900 leading-relaxed py-2">
                ...
                Inhalte waren zum Zeitpunkt der Verlinkung nicht erkennbar. Sollten wir von
                rechtswidrigen Inhalten auf verlinkten Seiten erfahren, werden wir den Link
            ...
            <div>
              ...
              <p className="font-paragraph text-slate-900 leading-relaxed mb-4 py-2">
                ...
                bedürfen der schriftlichen Zustimmung des Autors oder Urhebers. Downloads und Kopien
                dieser Seite sind nur für den privaten, nicht kommerziellen Gebrauch gestattet.
              </p>

              <p className="font-paragraph text-slate-900 leading-relaxed py-2">
                Soweit Inhalte auf dieser Seite nicht von uns erstellt wurden, werden die
            ...
            <div>
              ...
              <p className="font-paragraph text-slate-900 leading-relaxed py-2">
                ...
                an Dritte weitergegeben. Weitere Informationen finden Sie in unserer{' '}
                <a
                  href={ROUTES.datenschutz}
                  className="text-primary hover:underline font-bold py-2 inline-block"
                >
            ...
            <div>
              <h2 className="font-heading text-2xl font-bold text-primary mb-4">
                9. Hinweis nach § 36 VSBG (Verbraucherstreitbeilegungsgesetz)
              </h2>
              ...
              <div className="bg-yellow-50 border-2 border-yellow-300 rounded-lg p-6 font-paragraph text-slate-900 break-words">
                ...
                <p className="mb-4">
                  <strong>NEIN</strong> – Energievergleich.shop nimmt nicht an einem
                  Verbraucherstreitbeilegungsverfahren teil.
                </p>
                <p className="text-sm text-gray-700">
                  Energievergleich.shop ist nicht verpflichtet und nicht bereit, an einem
                  Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.
                  Für Beschwerden und Reklamationen kontaktieren Sie uns bitte direkt unter{' '}
                  <a
                    href={`mailto:${CONTACT.email}`}
                    className="text-primary hover:underline font-bold"
                  >
            ...
            <div>
              <h2 className="font-heading text-2xl font-bold text-primary mb-4">
                11. Verbraucherstreitbeilegung / Universalschiedsverfahren
              </h2>
