          ...
          <div className="space-y-8 break-words overflow-x-hidden min-w-0">
            ...
            <div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 space-y-4 font-paragraph text-slate-900 break-words">
                ...
                <div className="border-t pt-4">
                  ...
                  <p>E-Mail: <a href="mailto:support@energievergleich.nrw" className="text-primary hover:underline font-bold">support@energievergleich.nrw</a><br />Website: <a href="https://energievergleich.shop" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-bold">https://energievergleich.shop</a></p>
                </div>

                <div className="border-t pt-4">
                  <p className="font-bold mb-2">Inhaber/Geschäftsführer:</p>
                  <p>P. Kohmann, A. Danos</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 font-paragraph text-slate-900 break-words">
                ...
                <p>ENERGIEVERGLEICH NRW ist ein Informations- und Vergleichsportal für Energieversorgung. Es unterliegen keine speziellen berufsrechtlichen Regelungen für diese Tätigkeit.</p>
              </div>
            </div>
