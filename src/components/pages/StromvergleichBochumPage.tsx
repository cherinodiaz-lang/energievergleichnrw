  ...
  return (
    <StromvergleichCityLayout
      seo={{
        ...
        description:
          'Stromvergleich Bochum: Tarife vergleichen & bis zu 300€ jährlich sparen. ✓ Kostenlos ✓ Unabhängig ✓ TÜV-geprüft. Über 1000 Anbieter im Check!',
        keywords:
          'Stromvergleich Bochum, Stromtarife Bochum, Stromanbieter Bochum, Stromwechsel Bochum',
    ...
    >
        ...
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="font-paragraph text-lg md:text-xl text-white/90 mb-8 max-w-2xl">
              Mit wenigen Angaben sehen Sie verfügbare Optionen und können den Tarif auswählen, der
        ...
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16">
            <h2 className="font-heading text-2xl font-bold text-primary mb-6">
              Häufige Fragen zum Stromvergleich in Bochum
            </h2>
      ...
      <RelatedCities currentCity="bochum" />
    </StromvergleichCityLayout>
  );
}
