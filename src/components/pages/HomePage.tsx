...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden selection:bg-primary selection:text-white">
      ...
      {flags.heroVariant === 'B' ? (
        <HeroSectionV2 onCompare={(_plz) => { scrollToSection('vergleichsrechner'); }} />
      ) : (
                  ...
                  <Tabs defaultValue="strom" className="w-full">
                    ...
                    <div className="p-3 sm:p-6 md:p-8 bg-white">
                      ...
                      <TabsContent value="kombi" className="mt-0 space-y-4 sm:space-y-6">
                        <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 sm:p-6 text-center space-y-4">
                          <p className="text-sm sm:text-base text-slate-700 leading-6">
                            Für einen Strom- und Gas-Kombivergleich nutzen Sie unsere dedizierten Vergleichsrechner. So erhalten Sie die aktuellsten Tarife für beide Energiearten.
                          </p>
                          <div className="flex flex-col sm:flex-row gap-3 justify-center">
                            ...
                            <Link
                              to={ROUTES.gasvergleich}
                              onClick={() => trackCTAClick('Homepage Kombi Gas')}
                              className="inline-flex items-center justify-center gap-2 rounded-lg bg-secondary px-5 py-3 text-sm font-semibold text-secondary-foreground transition-colors hover:bg-secondary/90"
                            >
