...
export default function StromvergleichEssenPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const consumption = formData.verbrauch && parseInt(formData.verbrauch) > 0
      ? parseInt(formData.verbrauch)
      : 3500;
  ...
  const breadcrumbSchema = [
    ...
    { name: 'Stromvergleich Essen', url: `${typeof window !== 'undefined' ? window.location.origin : ''}/stromvergleich-essen` },
  ];
  ...
  return (
    <div className="min-h-screen bg-background break-words leading-mobile">
      ...
      <section className="w-full py-16 bg-white border-t">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          <h3 className="font-heading text-2xl font-bold text-primary mb-8">Weitere Themen</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Link to={ROUTES.gasvergleich} className="group">
              <Card className="h-full hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="font-paragraph text-sm text-gray-600 mb-4">Auch Gastarife vergleichen und zusätzlich sparen.</p>
            ...
            <Link to={ROUTES.photovoltaik} className="group">
              <Card className="h-full hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="font-paragraph text-sm text-gray-600 mb-4">Eigenen Strom produzieren: Infos & Beratung.</p>
                  <Button variant="outline" size="sm">Mehr erfahren</Button>
                </CardContent>
              </Card>
            </Link>
            <Link to={ROUTES.gewerbestrom} className="group">
              <Card className="h-full hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="font-paragraph text-sm text-gray-600 mb-4">Tarife für Unternehmen in NRW.</p>
                  <Button variant="outline" size="sm">Mehr erfahren</Button>
                </CardContent>
              </Card>
            </Link>
            <Link to={ROUTES.ratgeberStrom} className="group">
              <Card className="h-full hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="font-paragraph text-sm text-gray-600 mb-4">Tipps, Checklisten und Wechselwissen.</p>
                  <Button variant="outline" size="sm">Mehr erfahren</Button>
                </CardContent>
              </Card>
            </Link>
