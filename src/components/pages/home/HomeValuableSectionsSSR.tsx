...
const SSR_VORTEILE = [
  {
    ...
    description:
      'Durch regelmäßigen Tarifvergleich finden Sie oft deutlich günstigere Strom- und Gasangebote.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Von der Tarifauswahl bis zur Umstellung begleiten wir den Wechselprozess Schritt für Schritt.',
  },
];
            ...
            <Card className="border-none shadow-2xl bg-white/95 backdrop-blur-sm p-2">
              <CardContent className="pt-6 sm:pt-8 px-4 sm:px-8 pb-6 sm:pb-8">
                ...
                <Button asChild className="w-full bg-secondary text-secondary-foreground hover:bg-secondary/90 h-11 sm:h-14 text-sm sm:text-lg font-bold rounded-lg sm:rounded-xl">
                  <a href="mailto:kontakt@energievergleich.shop">Kontakt aufnehmen</a>
                </Button>
              </CardContent>
            </Card>
          </div>
