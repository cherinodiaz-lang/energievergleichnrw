...
const FAQ_ITEMS = [
  {
    question: 'Welche Daten brauche ich für den Stromvergleich in Münster?',
    answer:
      'Für den Stromvergleich in Münster reichen Postleitzahl und Ihr Jahresverbrauch (kWh). Optional hilft die Zählernummer für die spätere Beauftragung.',
  },
  {
    question: 'Ist der Stromanbieterwechsel in Münster kostenlos?',
    answer:
  ...
  {
    question: 'Wie lange dauert ein Stromwechsel in Münster?',
    answer:
