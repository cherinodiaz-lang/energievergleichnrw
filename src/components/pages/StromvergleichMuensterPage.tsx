      ...
      <section className="mx-auto w-full max-w-5xl px-4 py-10">
        ...
        <section className="space-y-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            Wenn du keinen Tarif auswählst, erfolgt die Belieferung über die Grundversorgung.
            Ein Vergleich ermöglicht, bessere Konditionen zu finden und Tarife transparent zu bewerten.
          </p>
          ...
          <div className="divide-y divide-gray-200 rounded-lg border border-gray-200">
            <details className="p-4">
              ...
              <p className="mt-2 text-gray-700">
                Ja, gerade dann lohnt sich der Blick auf den Grundpreis. Bei niedrigem Verbrauch kann
                ein hoher Grundpreis den Tarif unnötig verteuern.
              </p>
            </details>
            <details className="p-4">
        ...
        <footer className="mt-10 rounded-lg bg-gray-50 p-6">
          ...
          <p className="mt-2 text-gray-700">
            Der Tarifrechner wird später ergänzt. Dieses Grundkonstrukt ist bereits sauber strukturiert,
            damit wir danach intern verlinken, Sitemap/Indexierung stärken und die Vergleichsstrecke
            anbinden können.
          </p>
        </footer>
      </section>
