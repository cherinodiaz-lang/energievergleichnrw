      ...
      <section className="mx-auto w-full max-w-5xl px-4 py-10">
        <header className="mb-8">
          ...
          <p className="mt-4 text-lg leading-relaxed text-gray-700">
            Bonn ist eine wachsende Stadt mit vielfältigen Wohn- und Gewerbestrukturen.
            Ein regelmäßiger Stromvergleich hilft dir, passende Konditionen zu finden – besonders
            nach Umzug oder wenn Preisgarantien auslaufen.
          </p>
        </header>
        ...
        <section className="space-y-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            Ohne aktive Tarifwahl erfolgt die Belieferung über die Grundversorgung.
            Das ist unkompliziert, aber nicht automatisch günstig. Mit einem Vergleich kannst du
            Tarife nach Laufzeiten, Preisgarantie und Service sortieren.
          </p>
          ...
          <div className="divide-y divide-gray-200 rounded-lg border border-gray-200">
            <details className="p-4">
              ...
              <p className="mt-2 text-gray-700">
                Das hängt von deinem aktuellen Vertrag und der Kündigungsfrist ab.
                Der neue Anbieter übernimmt üblicherweise die Kündigung und koordiniert den Wechsel.
              </p>
            </details>
            <details className="p-4">
            ...
            <details className="p-4">
              ...
              <p className="mt-2 text-gray-700">
                Postleitzahl, Jahresverbrauch und idealerweise Daten aus der letzten Rechnung.
                Den Tarifrechner integrieren wir im nächsten Schritt.
              </p>
            </details>
          </div>
        </section>
        ...
        <footer className="mt-10 rounded-lg bg-gray-50 p-6">
          ...
          <p className="mt-2 text-gray-700">
            Der Tarifrechner wird später ergänzt. Diese Seite bildet bereits das SEO- und Struktur-
            Fundament, damit wir danach sauber erweitern können.
          </p>
        </footer>
      </section>
    </main>
