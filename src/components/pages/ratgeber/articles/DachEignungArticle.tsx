          ...
          >
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-12">
              <p className="font-paragraph text-gray-700 leading-relaxed">
                Nicht jedes Dach ist für Solaranlagen geeignet. Erfahren Sie, welche Kriterien Ihr
                Dach erfüllen sollte.
              </p>
            </div>
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <div className="space-y-4">
                ...
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Ideal ist eine Ausrichtung nach Süden mit einer Neigung von etwa 30-35 Grad. Aber
                  auch Ost- oder Westausrichtung ist möglich. Die Ausrichtung ist wichtiger als die
                  perfekte Neigung.
                </p>
              </div>

              <div className="space-y-4">
                <h2 className="font-heading text-3xl font-bold text-primary mb-4">Dachform</h2>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      Satteldächer: Ideal, gute Ausrichtung möglich
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      Flachdächer: Sehr gut, optimale Ausrichtung möglich
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      Pultdächer: Gut, je nach Ausrichtung
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-4">
                <h2 className="font-heading text-3xl font-bold text-primary mb-4">Dachfläche</h2>
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Für eine 5-kW-Anlage benötigen Sie etwa 25-30 m² Dachfläche. Für eine 10-kW-Anlage
                  etwa 50-60 m². Die genaue Fläche hängt von der Modulleistung ab.
                </p>
              </div>

              <div className="space-y-4">
                <h2 className="font-heading text-3xl font-bold text-primary mb-4">Verschattung</h2>
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Verschattung durch Bäume, Gebäude oder Schornsteine reduziert die Leistung. Auch
                  Teilschatten kann die Gesamtleistung deutlich senken. Ein Energieberater prüft
                  dies mit speziellen Geräten.
                </p>
              </div>
