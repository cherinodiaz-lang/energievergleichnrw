          ...
          >
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-12">
              <p className="font-paragraph text-gray-700 leading-relaxed">
                Bei einer Strompreiserhöhung haben Sie ein Sonderkündigungsrecht. Sie können mit
                einer Frist von 2 Wochen kündigen und zu einem günstigeren Anbieter wechseln. Nutzen
                Sie dieses Recht, um Kosten zu sparen.
              </p>
            </div>
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <div>
                ...
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Das Gesetz schützt Sie vor überraschenden Preiserhöhungen. Ihr Stromanbieter muss
                  Sie mindestens 6 Wochen vorher informieren. Sie haben dann ein
                  Sonderkündigungsrecht mit einer Frist von 2 Wochen.
                </p>
              </div>
              ...
              <div>
                ...
                <ol className="space-y-4 list-decimal list-inside">
                  <li className="font-paragraph text-gray-700">
                    <strong>Preiserhöhung erhalten:</strong> Ihr Anbieter teilt Ihnen die
                    Preiserhöhung schriftlich mit.
                  </li>
                  <li className="font-paragraph text-gray-700">
                    <strong>Frist beachten:</strong> Sie haben 2 Wochen ab dem Zeitpunkt der
                    Preiserhöhung Zeit zu kündigen.
                  </li>
                  <li className="font-paragraph text-gray-700">
                    <strong>Kündigung schreiben:</strong> Schreiben Sie eine schriftliche Kündigung
                    an Ihren Anbieter.
                  </li>
                  <li className="font-paragraph text-gray-700">
                    <strong>Neuen Anbieter wählen:</strong> Vergleichen Sie Tarife und wechseln Sie
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="font-paragraph text-gray-700">
                      Nutzen Sie einen Vergleichsrechner, um die besten Tarife zu finden
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      Achten Sie auf lange Preisgarantien (mindestens 12 Monate)
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      Vergleichen Sie nicht nur den Preis, sondern auch die Konditionen
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      Wechseln Sie regelmäßig, um immer den besten Tarif zu haben
                    </span>
                  </li>
                </ul>
              </div>
