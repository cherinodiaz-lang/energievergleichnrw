          ...
          >
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-12">
              <p className="font-paragraph text-gray-700 leading-relaxed">
                Neukundenboni klingen verlockend, verstecken aber oft Fallen. Hohe Grundpreise,
                kurze Preisgarantien und verzögerte Auszahlungen können die vermeintlichen
                Ersparnisse aufzehren. Wir zeigen Ihnen, wie Sie echte Ersparnisse erkennen.
              </p>
            </div>
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <div>
                ...
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Ein Neukundenbonus ist eine Geldleistung, die Sie erhalten, wenn Sie zu einem
                  neuen Anbieter wechseln. Der Bonus wird meist nach einigen Monaten ausbezahlt oder
                  direkt mit der Rechnung verrechnet. Typische Boni liegen zwischen 50 und 200 Euro.
                </p>
              </div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="font-paragraph text-gray-700">
                      <strong>Verzögerte Auszahlung:</strong> Bonus wird erst nach 12 Monaten
                      ausbezahlt
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      <strong>Hohe Grundpreise:</strong> Der Bonus wird durch höhere Grundpreise
                      kompensiert
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      <strong>Kurze Preisgarantie:</strong> Nach 12 Monaten steigen die Preise stark
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      <strong>Versteckte Bedingungen:</strong> Bonus nur unter bestimmten
                      Voraussetzungen
                    </span>
                  </li>
                </ul>
              ...
              <div>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 space-y-3">
                  <p className="font-paragraph text-gray-700">
                    <strong>Formel:</strong> (Arbeitspreis × Jahresverbrauch) + (Grundpreis × 12) +
                    Bonus = Gesamtkosten
                  </p>
                  <p className="font-paragraph text-gray-700 text-sm">
                    Vergleichen Sie diese Gesamtkosten mit Ihrem aktuellen Anbieter. Nur wenn die
                    Gesamtkosten günstiger sind, lohnt sich der Wechsel.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      Ist der Bonus in der Gesamtkostenberechnung enthalten?
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
