          ...
          >
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-12">
              <p className="font-paragraph text-gray-700 leading-relaxed">
                Eine Gaspreisgarantie gibt Ihnen Sicherheit bei Ihren Heizkosten. Erfahren Sie,
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <div>
                ...
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Eine Gaspreisgarantie bedeutet, dass der Gaspreis für einen bestimmten Zeitraum
                  nicht erhöht wird. Dies gibt Ihnen Planungssicherheit bei Ihren Heizkosten. Sie
                  wissen genau, wie viel Sie zahlen müssen.
                </p>
              </div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="font-paragraph text-gray-700">
                      12 Monate: Kürzere Garantie, oft günstiger
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      24 Monate: Längere Garantie, mehr Sicherheit
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      Wählen Sie je nach Ihrer Risikotoleranz
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Wichtig: Die Preisgarantie gilt nur für den Arbeitspreis und Grundpreis. Steuern
                  und Abgaben können trotzdem erhöht werden. Dies kann zu Preiserhöhungen führen,
                  obwohl eine Preisgarantie besteht.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Nach der Preisgarantie kann der Preis erhöht werden. Sie haben dann ein
                  Sonderkündigungsrecht mit 2 Wochen Frist. Dies gibt Ihnen die Möglichkeit, zu
