        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          >
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-12">
              <p className="font-paragraph text-gray-700 leading-relaxed">
                Die Kosten einer Solaranlage hängen von vielen Faktoren ab. Erfahren Sie, welche
                Faktoren den Preis beeinflussen und wie Sie die beste Anlage für Ihr Budget finden.
              </p>
            </div>
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <div className="space-y-4">
                ...
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Die Kosten einer Solaranlage setzen sich aus mehreren Komponenten zusammen:
                  Solarmodule, Wechselrichter, Montagesystem, Kabel und Zubehör sowie
                  Installationskosten. Jede Komponente trägt zu den Gesamtkosten bei.
                </p>
              </div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="font-paragraph text-gray-700">
                      Anlagengröße: Größere Anlagen sind pro kW günstiger
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      Modulqualität: Hochwertige Module sind teurer, aber zuverlässiger
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      Installationsaufwand: Komplexe Dächer sind teurer
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      Stromspeicher: Optional, aber erhöht die Kosten
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Es gibt verschiedene Förderungsmöglichkeiten, die die Kosten senken: KfW-Förderung
                  mit günstigen Krediten und Zuschüssen, Einspeisevergütung für Überschussstrom, und
                  regionale Förderprogramme in NRW. Informieren Sie sich über aktuelle Programme.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Mit Einspeisevergütung und Eigennutzung amortisiert sich eine Anlage in NRW meist
                  nach 8-12 Jahren. Danach produzieren Sie kostenlosen Strom für weitere 15-20
                  Jahre. Dies macht Solaranlagen wirtschaftlich attraktiv.
                </p>
              </div>
          ...
          <div className="bg-secondary/10 border border-secondary rounded-lg p-8 my-12">
            ...
            <p className="font-paragraph text-gray-700 mb-6">
              Nutzen Sie unsere kostenlose Beratung und erhalten Sie ein individuelles Angebot für
              Ihre Solaranlage.
            </p>
            <Button
              asChild
