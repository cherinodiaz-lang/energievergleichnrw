          ...
          >
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-12">
              <p className="font-paragraph text-gray-700 leading-relaxed">
                Ein Gasanbieterwechsel ist einfacher als viele denken. Mit wenigen Schritten können
                Sie zu einem günstigeren Anbieter wechseln und Heizkosten sparen. Der Wechsel ist
                kostenlos und Ihre Gasversorgung wird nicht unterbrochen.
              </p>
            </div>
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <div>
                ...
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Schauen Sie auf Ihre letzte Gasrechnung. Dort finden Sie Ihren jährlichen
                  Gasverbrauch in Kilowattstunden (kWh). Dieser Wert ist wichtig für den Vergleich.
                  Wenn Sie die genaue Zahl nicht haben, können Sie auch Ihre Wohnfläche angeben –
                  damit wird der Verbrauch geschätzt.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Nutzen Sie einen Vergleichsrechner und geben Sie Ihre Postleitzahl und Ihren
                  Gasverbrauch ein. Der Rechner zeigt Ihnen alle verfügbaren Tarife sortiert nach
                  Preis. Achten Sie nicht nur auf den Gesamtpreis, sondern auch auf Laufzeit,
                  Preisgarantie und Kündigungsfrist.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Wählen Sie einen Tarif, der zu Ihnen passt. Achten Sie darauf, dass die
                  Preisgarantie mindestens 12 Monate beträgt. Lesen Sie die Vertragsbedingungen
                  sorgfältig durch, bevor Sie sich anmelden.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Füllen Sie das Anmeldeformular aus und unterschreiben Sie den neuen Vertrag. Der
                  neue Gasanbieter kümmert sich um die Kündigung bei Ihrem alten Anbieter. Sie
                  müssen sich selbst nicht darum kümmern.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Nach etwa 4-6 Wochen erhalten Sie eine Bestätigung vom neuen Gasanbieter. Ab
                  diesem Zeitpunkt wird Ihr neuer Tarif berechnet. Ihre Gasversorgung läuft die
                  ganze Zeit über ohne Unterbrechung.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      Grundpreis: Vergleichen Sie auch den monatlichen Grundpreis
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      Boni: Achten Sie auf Neukundenboni und deren Bedingungen
                    </span>
                  </li>
                </ul>
              </div>
