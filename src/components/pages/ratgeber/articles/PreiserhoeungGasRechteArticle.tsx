          ...
          >
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-12">
              <p className="font-paragraph text-gray-700 leading-relaxed">
                Gaspreiserhöhungen sind ärgerlich, aber Sie haben Rechte. Mit dem
                Sonderkündigungsrecht können Sie schnell zu einem günstigeren Anbieter wechseln.
                Erfahren Sie hier, wie Sie richtig reagieren.
              </p>
            </div>
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <div>
                ...
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Bei einer Preiserhöhung haben Sie ein Sonderkündigungsrecht. Das bedeutet: Sie
                  können den Vertrag mit nur 2 Wochen Frist zum Zeitpunkt der Preiserhöhung
                  kündigen. Dies ist kostenlos und unabhängig von der ursprünglichen
                  Vertragslaufzeit.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-paragraph text-gray-700 leading-relaxed">
                  Der Gasanbieter muss eine Preiserhöhung mindestens 6 Wochen vorher schriftlich
                  ankündigen. Die Ankündigung muss die neuen Preise und den Zeitpunkt der Erhöhung
                  deutlich machen. Erst nach dieser Frist kann die Preiserhöhung wirksam werden.
                </p>
              </div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="font-paragraph text-gray-700">
                      <strong>Schritt 1:</strong> Ankündigung sorgfältig lesen und Datum notieren
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      <strong>Schritt 2:</strong> Gastarife vergleichen und bessere Angebote suchen
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      <strong>Schritt 3:</strong> Neuen Anbieter wählen und anmelden
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-gray-700">
                      <strong>Schritt 4:</strong> Alten Vertrag mit Sonderkündigungsrecht kündigen
                    </span>
                  </li>
                </ul>
              </div>
