  ...
  useEffect(() => {
    const faqSchema = {
      ...
      mainEntity: [
        {
          '@type': 'Question',
          name: 'Welche Daten brauche ich für den Stromvergleich in Düsseldorf?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Für den Stromvergleich in Düsseldorf reichen Postleitzahl und Ihr Jahresverbrauch (kWh). Optional hilft die Zählernummer für die spätere Beauftragung.',
          },
        },
        {
          '@type': 'Question',
          name: 'Ist der Stromanbieterwechsel in Düsseldorf kostenlos?',
          acceptedAnswer: {
            '@type': 'Answer',
        ...
        {
          '@type': 'Question',
          name: 'Wie lange dauert ein Stromwechsel in Düsseldorf?',
          acceptedAnswer: {
            '@type': 'Answer',
  ...
  return (
    <StromvergleichCityLayout
      seo={{
        ...
        keywords:
          'Stromvergleich Düsseldorf, Stromtarife Düsseldorf, Stromanbieter Düsseldorf, Stromwechsel Düsseldorf',
          ...
          <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="font-paragraph text-lg md:text-xl text-white/90 mb-8 max-w-2xl">
                Finden Sie den günstigsten Stromtarif in Düsseldorf. Kostenlos, unabhängig und in
                wenigen Minuten.
              </p>
            ...
            <div className="space-y-8">
              <div>
                <h2 className="font-heading text-3xl font-bold text-primary mb-6">
                  Kurz erklärt: Stromvergleich für Düsseldorf
                </h2>

                <p className="font-paragraph text-lg text-gray-700 mb-6">
                  Mit unserem Stromvergleich finden Sie in wenigen Minuten den günstigsten
                  Stromtarif für Ihren Haushalt in Düsseldorf. Der Vergleich ist völlig kostenlos
                  und unverbindlich – Sie geben nur Ihre Postleitzahl und Ihren Stromverbrauch ein
                  und erhalten sofort alle verfügbaren Tarife übersichtlich sortiert. Sparen Sie
                  durchschnittlich 200–400 Euro pro Jahr durch einen Wechsel zu einem besseren
                  Anbieter.
                </p>
              </div>
              ...
              <div>
                ...
                <ol className="font-paragraph text-gray-700 space-y-3 mb-6 list-decimal list-inside">
                  <li>
                    <strong>Postleitzahl eingeben:</strong> Geben Sie Ihre Düsseldorfer PLZ ein
                    (z.B. 40210, 40211, 40212), um Tarife für Ihren Netzbereich zu sehen
                  </li>
                  <li>
                    <strong>Stromverbrauch angeben:</strong> Tragen Sie Ihren jährlichen Verbrauch
                    in kWh ein (zu finden auf der Stromrechnung)
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Wechsel abschließen:</strong> Wir kümmern uns um die Kündigung beim
                    alten Anbieter und den Wechsel – kostenlos und sicher
                  </li>
                </ol>
              </div>
              ...
              <div>
                ...
                <ul className="font-paragraph text-gray-700 space-y-2 mb-6">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      <strong>Postleitzahl:</strong> Bestimmt Ihren Stromnetzbetreiber und
                      verfügbare Tarife in Düsseldorf
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-secondary font-bold flex-shrink-0">•</span>
                    <span>
                      <strong>Jahresverbrauch in kWh:</strong> Finden Sie auf Ihrer letzten
                      Stromrechnung unter „Verbrauch"
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-secondary font-bold flex-shrink-0">•</span>
                    <span>
                      <strong>Zählernummer (optional):</strong> Hilft bei der genauen
                      Tarifberechnung
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="font-paragraph text-gray-700 space-y-3 mb-6">
                  <li className="flex items-start gap-3">
                    <span className="text-secondary font-bold flex-shrink-0">✓</span>
                    <span>
                      <strong>Laufzeit:</strong> Kurze Laufzeiten (12 Monate) bieten mehr
                      Flexibilität als längere Verträge
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-secondary font-bold flex-shrink-0">✓</span>
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-secondary font-bold flex-shrink-0">✓</span>
                    <span>
                      <strong>Neukundenbonus:</strong> Viele Anbieter bieten Wechselboni, die die
                      Gesamtkosten senken
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-heading text-2xl font-bold text-primary mb-4">
                  Häufige Fehler beim Stromwechsel
                </h3>
                <ul className="font-paragraph text-gray-700 space-y-3 mb-6">
                  <li className="flex items-start gap-3">
                    <span className="text-secondary font-bold flex-shrink-0">✗</span>
                    <span>
                      <strong>Nur auf den Preis schauen:</strong> Der niedrigste Preis ist nicht
                      immer die beste Wahl – achten Sie auch auf Laufzeit, Preisgarantie und
                      Kündigungsfristen
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-heading text-2xl font-bold text-primary mb-4">
                  Stromvergleich speziell für Düsseldorf
                </h3>
                <p className="font-paragraph text-gray-700 mb-4">
                  Düsseldorf ist mit über 600.000 Einwohnern eine der größten Städte Deutschlands
                  und Landeshauptstadt von Nordrhein- Westfalen. Die Stadt hat eine vielfältige
                  Strommarkt-Landschaft mit mehreren Netzgebieten und Stromanbietern. Die
                  Strompreise variieren je nach Postleitzahl und Netzbetreiber – in der Altstadt
                  (40213) können die Tarife anders ausfallen als in Düsseldorf-Gerresheim (40625)
                  oder Düsseldorf-Benrath (40597). Unser Vergleich berücksichtigt diese regionalen
                  Unterschiede und zeigt Ihnen die besten Tarife speziell für Ihren Standort in
                  Düsseldorf.
                </p>
                <p className="font-paragraph text-gray-700 mb-4">
                  Düsseldorf ist bekannt für seine wirtschaftliche Stärke und als Finanzplatz. Dies
                  führt zu einer hohen Nachfrage nach Stromtarifen und vielen Angeboten von
                  verschiedenen Anbietern. Besonders für Neubau- und Renovierungsprojekte in
                  Düsseldorf gibt es spezielle Tarife. Nutzen Sie unseren Vergleichsrechner, um die
                  besten Konditionen für Ihre Situation zu finden.
                </p>
              </div>

              <div className="bg-secondary/10 border-l-4 border-secondary p-6 rounded">
                <p className="font-paragraph text-gray-700 italic">
                  Jetzt kostenlos vergleichen und sparen Sie ab sofort bei Ihren Stromkosten in
                  Düsseldorf!
                </p>
              </div>
            </div>
          ...
          <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="space-y-8">
              <div>
                ...
                <p className="font-paragraph text-lg text-gray-700 mb-6">
                  Stadtwerke Düsseldorf ist der Grundversorger für Düsseldorf und die unmittelbare
                  Region. Als Grundversorger ist Stadtwerke Düsseldorf verpflichtet, jeden Haushalt
                  mit Strom zu versorgen – unabhängig davon, ob Sie aktiv einen Vertrag
                  abgeschlossen haben oder nicht. Dies ist ein wichtiger Schutzmechanismus für
                  Verbraucher, garantiert aber nicht automatisch die günstigsten Preise.
                </p>

                <p className="font-paragraph text-lg text-gray-700 mb-6">
                  Die Grundversorgungstarife von Stadtwerke Düsseldorf setzen sich aus mehreren
                  Komponenten zusammen: dem Arbeitspreis (€/kWh), der Grundgebühr (€/Monat) und den
                  Netzentgelte. Diese Tarife sind oft höher als Sondertarife bei anderen Anbietern,
                  weshalb ein Wechsel für viele Düsseldorfer Haushalte sinnvoll ist. Mit unserem
                  Vergleichsrechner können Sie schnell sehen, wie viel Sie durch einen Wechsel
                  sparen können.
                </p>
              </div>
              ...
              <div>
                <h3 className="font-heading text-2xl font-bold text-primary mb-4">
                  Kündigungsfristen in Düsseldorf
                </h3>
                <p className="font-paragraph text-gray-700 mb-4">
                  Die Kündigungsfristen sind ein wichtiger Faktor beim Stromwechsel. Bei der
                  Grundversorgung von Stadtwerke Düsseldorf beträgt die Kündigungsfrist 2 Wochen zum
                  Ende eines Kalendermonats. Das bedeutet: Wenn Sie Ihren Vertrag am 15. Januar
                  kündigen, endet dieser am 31. Januar. Dies ist eine der kürzeren Fristen und
                  bietet Ihnen Flexibilität.
                </p>
                <p className="font-paragraph text-gray-700 mb-4">
                  Bei Sondertarifen anderer Anbieter liegt die Kündigungsfrist meist bei 4 Wochen
                  zum Ende eines Kalendermonats. Achten Sie auf die genaue Kündigungsfrist in Ihrem
                  Vertrag – diese finden Sie in den Vertragsbedingungen oder auf Ihrer Rechnung.
                  Besonders wichtig: Wenn Sie einen Vertrag mit längerer Laufzeit (z.B. 24 Monate)
                  abschließen, können Sie diesen oft nur zum Ende der Laufzeit kündigen, es sei
                  denn, es gibt ein Sonderkündigungsrecht (z.B. bei Preiserhöhungen).
                </p>
              </div>

              <div>
                <h3 className="font-heading text-2xl font-bold text-primary mb-4">
                  Umzugsszenarien in Düsseldorf
                </h3>
                <p className="font-paragraph text-gray-700 mb-4">
                  Düsseldorf ist eine dynamische Stadt mit vielen Menschen, die umziehen. Wenn Sie
                  in Düsseldorf umziehen, sollten Sie Ihren Stromvertrag rechtzeitig (mindestens 4
                  Wochen vorher) kündigen oder einen neuen Tarif für die neue Adresse abschließen.
                  Nutzen Sie unseren Vergleichsrechner mit Ihrer neuen Postleitzahl, um die besten
                  Tarife für Ihre neue Wohnung zu finden.
                </p>
                <p className="font-paragraph text-gray-700 mb-4">
                  Wichtig: Die Stromversorgung wird bei einem Umzug nicht unterbrochen. Wenn Sie
                  keinen neuen Vertrag abschließen, werden Sie automatisch von Stadtwerke Düsseldorf
                  in der Grundversorgung beliefert. Dies ist zwar sicher, aber oft teurer als ein
                  Sondertarif. Daher empfehlen wir, rechtzeitig einen neuen Tarif zu suchen.
                  Besonderheit in Düsseldorf: Je nach Stadtteil (z.B. Düsseldorf-Benrath,
                  Düsseldorf-Gerresheim, Düsseldorf-Pempelfort) können unterschiedliche
                  Netzbetreiber zuständig sein, was zu unterschiedlichen Tarifoptionen führt.
                </p>
              </div>

              <div>
                <h3 className="font-heading text-2xl font-bold text-primary mb-4">
                  Besonderheiten der Düsseldorfer Strommarkt
                </h3>
                <ul className="font-paragraph text-gray-700 space-y-3 mb-6">
                  <li className="flex items-start gap-3">
                    <span className="text-secondary font-bold flex-shrink-0">•</span>
                    <span>
                      <strong>Mehrere Netzgebiete:</strong> Düsseldorf hat mehrere Netzgebiete mit
                      unterschiedlichen Netzbetreibern, was zu unterschiedlichen Tarifoptionen führt
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-secondary font-bold flex-shrink-0">•</span>
                    <span>
                      <strong>Stadtwerke-Dominanz:</strong> Stadtwerke Düsseldorf ist der größte
                      Anbieter in Düsseldorf und oft auch der Grundversorger
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-secondary font-bold flex-shrink-0">•</span>
                    <span>
                      <strong>Ökostrom-Optionen:</strong> Düsseldorf hat eine starke Nachfrage nach
                      Ökostrom, weshalb viele Anbieter grüne Tarife anbieten
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-secondary font-bold flex-shrink-0">•</span>
                    <span>
                      <strong>Wechselbonus:</strong> Viele Anbieter bieten Wechselboni für Neukunden
                      in Düsseldorf an
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      <strong>Preisgarantie:</strong> Achten Sie auf die Dauer der Preisgarantie –
                      in Düsseldorf sind 12-24 Monate üblich
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-blue-50 border-l-4 border-primary p-6 rounded">
                <h4 className="font-heading font-bold text-primary mb-3">
                  Tipp für Düsseldorfer Haushalte:
                </h4>
                <p className="font-paragraph text-gray-700">
                  Nutzen Sie unseren Vergleichsrechner regelmäßig – mindestens einmal pro Jahr. Die
                  Strompreise ändern sich ständig, und durch einen rechtzeitigen Wechsel können Sie
                  hunderte Euro pro Jahr sparen. Besonders nach Preiserhöhungen von Stadtwerke
                  Düsseldorf lohnt sich ein Vergleich, da Sie oft ein Sonderkündigungsrecht haben.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                <div className="bg-white rounded-2xl p-8 shadow-lg h-full">
                  ...
                  <p className="font-paragraph text-gray-600">
                    Geben Sie Ihre Postleitzahl und Ihren Stromverbrauch ein. Das dauert nur wenige
                    Sekunden.
                  </p>
                </div>
              </motion.div>
              ...
              >
                <div className="bg-white rounded-2xl p-8 shadow-lg h-full">
                  ...
                  <p className="font-paragraph text-gray-600">
                    Sehen Sie alle verfügbaren Tarife mit Preis, Laufzeit und Preisgarantie auf
                    einen Blick.
                  </p>
                </div>
              </motion.div>
              ...
              >
                <div className="bg-white rounded-2xl p-8 shadow-lg h-full">
                  ...
                  <p className="font-paragraph text-gray-600">
                    Wählen Sie Ihren Wunsch-Tarif und wir kümmern uns um alle Formalitäten.
        ...
        <section className="w-full py-24 bg-white">
          <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <ol className="font-paragraph text-gray-700 space-y-4 list-decimal list-inside">
              <li>
                <strong>Postleitzahl und Verbrauch eingeben:</strong> Nutzen Sie unseren
                Vergleichsrechner mit Ihren Basisdaten.
              </li>
              <li>
                <strong>Tarife vergleichen:</strong> Sehen Sie alle verfügbaren Angebote sortiert
                nach Preis und Konditionen.
              </li>
              <li>
                <strong>Wunsch-Tarif wählen:</strong> Entscheiden Sie sich für den Tarif, der am
                besten zu Ihnen passt.
              </li>
              <li>
                <strong>Angebot anfordern:</strong> Kontaktieren Sie den Anbieter oder lassen Sie
                sich von uns beraten.
              </li>
              <li>
                <strong>Wechsel abschließen:</strong> Wir kümmern uns um die Kündigung und den
                Wechsel – kostenlos und sicher.
              </li>
            </ol>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  title: 'Laufzeit',
                  description:
                    'Flexible Laufzeiten von 12 bis 24 Monaten für maximale Flexibilität.',
                },
                {
                  title: 'Preisgarantie',
                ...
                },
                {
                  ...
                  description:
                    'Kurze Kündigungsfristen geben Ihnen mehr Flexibilität beim Wechsel.',
                },
                {
                  title: 'Boni & Rabatte',
                ...
                },
                {
                  title: 'Öko-Optionen',
                  description:
                    'Grüne Tarife mit Ökostrom-Zertifikaten sind oft günstiger als gedacht.',
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
          ...
          <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="space-y-4 font-paragraph text-gray-700 leading-relaxed">
                <p>
                  Bei energievergleich.shop vergleichen Sie Stromtarife völlig transparent und
                  unabhängig. Wir sind nicht an einen Anbieter gebunden und zeigen Ihnen alle
                  verfügbaren Optionen in Ihrer Region – sortiert nach Preis und
                  Vertragsbedingungen. Unser Service ist für Sie kostenlos: Wir verdienen kein Geld
                  mit Ihrem Wechsel, sondern nur durch Provisionen von Anbietern, die Sie selbst
                  gewählt haben.
                </p>
                <p>
                  Wir vergleichen nicht nur Preise, sondern auch Laufzeiten, Preisgarantien und
                  Kündigungsfristen. So finden Sie den Tarif, der wirklich zu Ihnen passt – nicht
                  nur der billigste. Alle Informationen auf dieser Seite sind aktuell und wurden
                  zuletzt im Februar 2026 überprüft.
                </p>
                <p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                ...
                <Card className="h-full hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <p className="font-paragraph text-sm text-gray-600 mb-4">
                      Vergleichen Sie auch Ihre Gastarife und sparen Sie zusätzlich.
                    </p>
              ...
              <Link to={ROUTES.gewerbestrom} className="group">
                <Card className="h-full hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <p className="font-paragraph text-sm text-gray-600 mb-4">
                      Spezielle Stromtarife für Ihr Unternehmen.
                    </p>
                    <Button variant="outline" size="sm">
                      Mehr erfahren
                    </Button>
              ...
              <Link to={ROUTES.ratgeberStrom} className="group">
                <Card className="h-full hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <p className="font-paragraph text-sm text-gray-600 mb-4">
                      Tipps und Wissen rund um Stromtarife.
                    </p>
                    <Button variant="outline" size="sm">
                      Mehr erfahren
                    </Button>
