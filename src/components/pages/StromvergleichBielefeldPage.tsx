      ...
      <section className="mx-auto w-full max-w-5xl px-4 py-10">
        ...
        <section className="space-y-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            Wer keinen Tarif auswählt, wird automatisch über die Grundversorgung beliefert.
            Das ist unkompliziert, aber häufig nicht die günstigste Option. Ein Vergleich hilft dir,
            Preisbestandteile (Grundpreis/Arbeitspreis), Laufzeiten und Konditionen wie Preisgarantien
            richtig zu bewerten.
          </p>
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            Bei höherem Verbrauch oder speziellen Anforderungen lohnt sich eine gesonderte Betrachtung.
          </p>
          ...
          <div className="divide-y divide-gray-200 rounded-lg border border-gray-200">
            <details className="p-4">
              ...
              <p className="mt-2 text-gray-700">
                Häufig ja – weil Konditionen sich ändern und viele Haushalte in älteren Tarifen oder
                in der Grundversorgung bleiben. Entscheidend sind Verbrauch und Vertragsdetails.
              </p>
            </details>
            <details className="p-4">
              <summary className="cursor-pointer font-medium text-gray-900">Gibt es beim Wechsel eine Stromunterbrechung?</summary>
              <p className="mt-2 text-gray-700">
                In der Regel nicht. Die Versorgung bleibt stabil, der Netzbetreiber bleibt derselbe –
                nur der Liefervertrag ändert sich.
              </p>
            </details>
            <details className="p-4">
              <summary className="cursor-pointer font-medium text-gray-900">Was brauche ich für den Vergleich?</summary>
              <p className="mt-2 text-gray-700">
                Postleitzahl, grober Jahresverbrauch (kWh) und idealerweise Daten aus der letzten Rechnung.
                Den Tarifrechner integrieren wir als nächsten Schritt.
              </p>
            </details>
          </div>
        </section>
