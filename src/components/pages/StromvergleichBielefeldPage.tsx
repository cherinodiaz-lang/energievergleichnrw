...
const FAQ_ITEMS = [
  {
    question: 'Welche Daten brauche ich für den Stromvergleich in Bielefeld?',
    answer:
      'Für den Stromvergleich in Bielefeld reichen Postleitzahl und Ihr Jahresverbrauch (kWh). Optional hilft die Zählernummer für die spätere Beauftragung.',
  },
  {
    question: 'Ist der Stromanbieterwechsel in Bielefeld kostenlos?',
    answer:
  ...
  {
    question: 'Wie lange dauert ein Stromwechsel in Bielefeld?',
    answer:
