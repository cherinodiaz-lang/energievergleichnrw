...
export default function StromvergleichKoelnPage() {
  ...
  const breadcrumbSchema = [
    ...
    { name: 'Stromvergleich Köln', url: `${typeof window !== 'undefined' ? window.location.origin : ''}https://www.energievergleich.shop/stromvergleich-koeln` },
  ];
  ...
  return (
    <div className="min-h-screen bg-background break-words leading-mobile">
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-sm">Alle Anbieter in Köln</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <ol className="font-paragraph text-gray-700 space-y-3 mb-6 list-decimal list-inside">
                <li><strong>Postleitzahl eingeben:</strong> Geben Sie Ihre Kölner PLZ ein (z.B. 50667, 50668, 50969), um Tarife für Ihren Netzbereich zu sehen</li>
            ...
            <div>
              ...
              <ul className="font-paragraph text-gray-700 space-y-2 mb-6">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>Postleitzahl:</strong> Bestimmt Ihren Stromnetzbetreiber und verfügbare Tarife in Köln</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">•</span>
      ...
      {/* Kölner Grundversorgung Section */}
      <section className="w-full py-24 bg-background">
        <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="space-y-8">
            <div>
              <h2 className="font-heading text-3xl font-bold text-primary mb-6">Kölner Grundversorgung: RheinEnergie und Alternativen</h2>
              
              <p className="font-paragraph text-lg text-gray-700 mb-6">
                RheinEnergie ist der Grundversorger für Köln und die umliegenden Regionen. Als Grundversorger ist RheinEnergie verpflichtet, jeden Haushalt mit Strom zu versorgen – unabhängig davon, ob Sie aktiv einen Vertrag abgeschlossen haben oder nicht. Dies ist ein wichtiger Schutzmechanismus für Verbraucher, garantiert aber nicht automatisch die günstigsten Preise.
              </p>
            ...
            <div>
              <h3 className="font-heading text-2xl font-bold text-primary mb-4">Kündigungsfristen in Köln</h3>
              <p className="font-paragraph text-gray-700 mb-4">
                Die Kündigungsfristen sind ein wichtiger Faktor beim Stromwechsel. Bei der Grundversorgung von RheinEnergie beträgt die Kündigungsfrist 2 Wochen zum Ende eines Kalendermonats. Das bedeutet: Wenn Sie Ihren Vertrag am 15. Januar kündigen, endet dieser am 31. Januar. Dies ist eine der kürzeren Fristen und bietet Ihnen Flexibilität.
              </p>
              <p className="font-paragraph text-gray-700 mb-4">
            ...
            <div>
              <h3 className="font-heading text-2xl font-bold text-primary mb-4">Besonderheiten der Kölner Strommarkt</h3>
              <ul className="font-paragraph text-gray-700 space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">•</span>
                  <span><strong>Vielfältige Netzgebiete:</strong> Köln hat mehrere Netzgebiete mit unterschiedlichen Netzbetreibern, was zu unterschiedlichen Tarifoptionen führt</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">•</span>
                  <span><strong>RheinEnergie-Dominanz:</strong> RheinEnergie ist der größte Anbieter in Köln und oft auch der Grundversorger</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">•</span>
                  <span><strong>Ökostrom-Optionen:</strong> Köln hat eine starke Nachfrage nach Ökostrom, weshalb viele Anbieter grüne Tarife anbieten</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">•</span>
                  <span><strong>Wechselbonus:</strong> Viele Anbieter bieten Wechselboni für Neukunden in Köln an</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold flex-shrink-0">•</span>
                  <span><strong>Preisgarantie:</strong> Achten Sie auf die Dauer der Preisgarantie – in Köln sind 12-24 Monate üblich</span>
                </li>
              </ul>
            </div>
        ...
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              {
                icon: MapPin,
                title: 'Lokal für Köln',
                description: 'Speziell für Kölner Haushalte.'
              },
              {
                icon: BarChart3,
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: 'Sie können jederzeit wechseln, müssen aber die Kündigungsfrist einhalten. Nach einem Wechsel können Sie frühestens nach 12 Monaten erneut wechseln, es sei denn, Sie haben einen Vertrag mit kürzerer Laufzeit abgeschlossen.'
              },
              {
                q: 'Ist der Stromwechsel in Köln kostenlos?',
              ...
              },
              {
                ...
                a: 'Nein. Ihre Stromversorgung ist gesetzlich geschützt. Im Notfall springt der Grundversorger (RheinEnergie) ein und beliefert Sie mit Strom.'
              },
              {
                q: 'Welche Daten benötige ich für einen Stromwechsel in Köln?',
                a: 'Sie benötigen Ihre Postleitzahl (z.B. 50667 für die Innenstadt), Ihren jährlichen Stromverbrauch (in kWh) und optional Ihre Zählernummer.'
              },
              {
