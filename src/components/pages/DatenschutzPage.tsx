          ...
          <div className="space-y-8 break-words overflow-x-hidden min-w-0">
            ...
            <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-6">
              <h3 className="font-heading text-lg font-bold text-blue-900 mb-4">
                ℹ️ Datenschutzerklärung
              </h3>
              <p className="text-sm text-blue-800 font-paragraph">
                Diese Datenschutzerklärung entspricht den Anforderungen der DSGVO und informiert Sie
            ...
            {/* 1. Verantwortlicher */}
            <div>
              <h2 className="font-heading text-3xl font-bold text-primary mb-6 mt-6">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 space-y-4 font-paragraph text-slate-900 break-words">
                ...
                <div className="border-t pt-4">
                  ...
                  <p className="text-sm text-gray-500 mt-2">
                    Hinweis: Für Datenschutzfragen kontaktieren Sie bitte direkt die oben genannte
                    Adresse.
                  </p>
                </div>
              </div>
            ...
            <div>
              ...
              <p className="font-paragraph text-slate-900 mb-6">
                Wir verarbeiten personenbezogene Daten nur, wenn dies rechtlich zulässig ist.
                Nachfolgend erhalten Sie einen Überblick über die Verarbeitungen:
              </p>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 space-y-4 font-paragraph text-slate-900 mb-6 break-words">
                ...
                <div>
                  ...
                  <p>
                    IP-Adresse, Browser-Typ, Betriebssystem, Referrer-URL, Zugriffsdatum und
                    -uhrzeit, Anfragegröße, HTTP-Statuscode
                  </p>
                </div>
                ...
                <div className="border-t pt-4">
                  ...
                  <p>
                    Wix.com Ltd. (Hosting-Provider)
                    <br />
                    Datenschutzerklärung:{' '}
                    <a
                      href="https://www.wix.com/de/privacy"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-primary hover:underline break-all"
                    >
                      https://www.wix.com/de/privacy
                    </a>
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 space-y-4 font-paragraph text-slate-900 mb-6 break-words">
                ...
                <div>
                  <p className="font-bold mb-2">Verarbeitete Daten:</p>
                  <p>
                    Name, E-Mail-Adresse, Telefonnummer (optional), Nachrichtentext,
                    Anfragekategorie
                  </p>
                </div>
                ...
                <div className="border-t pt-4">
                  <p className="font-bold mb-2">Rechtsgrundlage:</p>
                  <p>
                    Art. 6 Abs. 1 lit. b DSGVO (Vertragsanbahnung) oder Art. 6 Abs. 1 lit. a DSGVO
                    (Einwilligung)
                  </p>
                </div>
                ...
                <div className="border-t pt-4">
                  <p className="font-bold mb-2">Speicherdauer:</p>
                  <p>
                    Bis zur vollständigen Bearbeitung der Anfrage, danach 12 Monate (Musterwert für
                    Archivierung)
                  </p>
                </div>
                ...
                <div className="border-t pt-4">
                  ...
                  <p>
                    Interne Bearbeitung durch Energievergleich Muster GmbH, ggf. Weitergabe an
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 space-y-4 font-paragraph text-slate-900 mb-6 break-words">
                <h3 className="font-bold text-lg text-primary">
                  2.3 Direktkontakt per E-Mail oder Telefon
                </h3>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 space-y-4 font-paragraph text-slate-900 mb-6 break-words">
                ...
                <div className="border-t pt-4">
                  <p className="font-bold mb-2">Zweck:</p>
                  <p>
                    Gewährleistung der Funktionalität der Website, Speicherung von
                    Benutzereinstellungen, Verwaltung von Datenschutzeinwilligungen
                  </p>
                </div>
                ...
                <div className="border-t pt-4">
                  <p className="font-bold mb-2">Rechtsgrundlage:</p>
                  <p>
                    Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse) für notwendige Cookies; Art.
                    6 Abs. 1 lit. a DSGVO (Einwilligung) für nicht-notwendige Cookies
                  </p>
                </div>
                ...
                <div className="border-t pt-4">
                  <p className="font-bold mb-2">Speicherdauer:</p>
                  <p>
                    Abhängig vom Cookie-Typ, in der Regel bis zum Ende der Browsersitzung oder bis
                    zur Löschung (Musterwert)
                  </p>
                </div>

                <div className="border-t pt-4">
                  <p className="text-sm text-gray-500">
                    Hinweis: Weitere Informationen zu Cookies finden Sie in unserem Cookie-Banner
                    auf der Website. Sie können Ihre Cookie-Einstellungen jederzeit über die
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 space-y-4 font-paragraph text-slate-900 mb-6 break-words">
                <h3 className="font-bold text-lg text-primary">
                  2.5 Analyse und Tracking - Google Analytics 4 (GA4)
                </h3>

                <div className="bg-green-50 border border-green-200 rounded p-4 mb-4">
                  <p className="text-sm text-green-800 font-bold">
                    Status: Aktiv (mit Consent-Handling)
                  </p>
                  <p className="text-sm text-green-700 mt-2">
                    Google Analytics 4 wird nur nach ausdrücklicher Einwilligung des Nutzers
                    aktiviert.
                  </p>
                </div>
                ...
                <div>
                  <p className="font-bold mb-2">Verarbeitete Daten:</p>
                  <p>
                    IP-Adresse (anonymisiert), Geräte-ID, Browser-Informationen, Betriebssystem,
                    Besuchte Seiten, Verweildauer, Klicks, Scroll-Verhalten, Referrer, Gerätetyp,
                    Spracheinstellungen
                  </p>
                </div>
                ...
                <div className="border-t pt-4">
                  <p className="font-bold mb-2">Zweck:</p>
                  <p>
                    Analyse des Nutzerverhaltens, Optimierung der Website-Performance, Erstellung
                    von Statistiken, Verbesserung der Benutzerfreundlichkeit
                  </p>
                </div>
                ...
                <div className="border-t pt-4">
                  <p className="font-bold mb-2">Rechtsgrundlage:</p>
                  <p>
                    Art. 6 Abs. 1 lit. a DSGVO (Einwilligung) - GA4 wird AUSSCHLIESSLICH nach
                    Erteilung der Einwilligung durch den Nutzer aktiviert
                  </p>
                </div>
                ...
                <div className="border-t pt-4">
                  ...
                  <p>
                    Daten werden in die USA übermittelt. Google hat sich dem EU-US Data Privacy
                    Framework angeschlossen. Weitere Informationen:{' '}
                    <a
                ...
                <div className="border-t pt-4">
                  <p className="text-sm text-gray-500">
                    Hinweis: Sie können Ihre Einwilligung jederzeit über die
                    Datenschutzeinstellungen (Cookie-Banner) widerrufen. GA4 wird dann sofort
                    deaktiviert.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 space-y-4 font-paragraph text-slate-900 mb-6 break-words">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded p-4 mb-4">
                  <p className="text-sm text-blue-800 font-bold">
                    Status: Nicht im Einsatz (Musterangabe)
                  </p>
                  <p className="text-sm text-blue-700 mt-2">
                    Derzeit werden keine externen Dienste eingebettet.
                  </p>
                </div>
                ...
                <div className="border-t pt-4">
                  <p className="text-sm text-gray-500">
                    Hinweis: Sollten externe Dienste zukünftig eingesetzt werden, wird diese
                    Datenschutzerklärung entsprechend aktualisiert. Externe Dienste können Daten in
                    Länder außerhalb der EU übermitteln.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              <h2 className="font-heading text-3xl font-bold text-primary mb-6 mt-6">
                3. Ihre Rechte nach der DSGVO (Art. 15-22 DSGVO)
              </h2>
              ...
              <div className="space-y-4 font-paragraph text-slate-900">
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  ...
                  <p>
                    ...
                    wir über Sie speichern, woher diese stammen und wie wir sie verwenden.
                  </p>
                </div>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  ...
                  <p>
                    Sie können unter bestimmten Bedingungen die Löschung Ihrer Daten verlangen
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  ...
                  <p>
                    Sie können Ihre Daten in einem strukturierten, gängigen und maschinenlesbaren
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  ...
                  <p>
                    ...
                    Verarbeitung für Direktmarketing oder Profiling.
                  </p>
                </div>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  ...
                  <p>
                    Sie haben das Recht, sich bei einer Datenschutzbehörde zu beschweren, wenn Sie
            ...
            <div>
              <h2 className="font-heading text-3xl font-bold text-primary mb-6 mt-6">
                5. Zuständige Datenschutzbehörde
              </h2>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 font-paragraph text-slate-900 break-words">
                ...
                <p className="text-sm text-gray-500">
                  Diese Angabe ist eine Musterangabe für Unternehmen in NRW.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="font-paragraph text-slate-900">
                ...
                aktuelle Fassung finden Sie immer auf dieser Seite. Wesentliche Änderungen werden
                wir Ihnen per E-Mail oder durch einen prominenten Hinweis auf unserer Website
                mitteilen.
              </p>
            </div>
            ...
            <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-6 mt-8">
              <p className="font-paragraph text-sm text-slate-900">
                ...
                spezifischen Anforderungen und Praktiken Ihres Unternehmens angepasst werden. Bitte
                konsultieren Sie einen Rechtsanwalt, um sicherzustellen, dass Ihre
                Datenschutzerklärung vollständig und konform mit der DSGVO ist.
              </p>
            </div>
          </div>
        </div>
