...
export default function StromvergleichNrwPage() {
  ...
  const breadcrumbSchema = [
    ...
    },
    {
      ...
      url: `${typeof window !== 'undefined' ? window.location.origin : ''}${ROUTES.stromvergleich}`,
    },
  ];
        ...
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="font-paragraph text-lg md:text-xl text-white/90 mb-8 max-w-2xl">
              Finden Sie den günstigsten Stromtarif in Ihrer Region. Kostenlos, unabhängig und in
              wenigen Minuten.
            </p>
          ...
          <div className="space-y-8">
            <div>
              <h2 className="font-heading text-3xl font-bold text-primary mb-6">
                Kurz erklärt: Stromvergleich für NRW
              </h2>
              ...
              <p className="font-paragraph text-lg text-gray-700 mb-6">
                ...
                für Ihren Haushalt in Nordrhein-Westfalen. Der Vergleich ist völlig kostenlos und
                unverbindlich – Sie geben nur Ihre Postleitzahl und Ihren Stromverbrauch ein und
                erhalten sofort alle verfügbaren Tarife übersichtlich sortiert. Sparen Sie
            ...
            <div>
              <h3 className="font-heading text-2xl font-bold text-primary mb-4">
                Stromvergleich speziell für NRW
              </h3>
              <p className="font-paragraph text-gray-700 mb-4">
                ...
                Vielfalt bei Stromanbietern und Tarifen. Die Strompreise variieren je nach
                Postleitzahl und Netzbetreiber – in Düsseldorf können die Tarife anders ausfallen
                als in Köln, Essen oder Dortmund. Unser Vergleich berücksichtigt diese regionalen
                Unterschiede und zeigt Ihnen die besten Tarife speziell für Ihren Standort in NRW.
              </p>
            </div>
