...
export default function HeroSection() {
  return (
    <section className="relative w-full bg-gradient-to-br from-primary via-primary to-primary-dark py-12 sm:py-16 md:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="relative max-w-[100rem] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-3 sm:px-4 py-2 rounded-full mb-4 sm:mb-6 border border-white/20">
            <TrendingDown className="w-4 h-4 text-secondary flex-shrink-0" />
            <span className="text-xs sm:text-sm font-medium text-white">Bis zu 30% sparen</span>
          </div>

          <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-4 sm:mb-6 leading-tight">
            Energie sparen,<br className="hidden sm:block" />
            <span className="text-secondary">Geld verdienen</span>
          </h1>

          <p className="font-paragraph text-base sm:text-lg md:text-xl text-white/90 max-w-2xl mx-auto mb-6 sm:mb-8 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <Link to="/stromvergleich-nrw" className="w-full sm:w-auto">
              <Button size="lg" className="w-full sm:w-auto bg-secondary hover:bg-secondary/90 text-black font-semibold">
                Jetzt vergleichen
