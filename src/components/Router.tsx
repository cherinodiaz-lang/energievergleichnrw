...
const GewerbestromPage = lazy(() =>
  import('@/components/pages/GewerbestromPage').catch(() => ({ default: LazyErrorFallback }))
);
const GewerbegasPage = lazy(() =>
  import('@/components/pages/GewerbegasPage').catch(() => ({ default: LazyErrorFallback }))
);
const StromvergleichNrwPage = lazy(() =>
  import('@/components/pages/StromvergleichNrwPage').catch(() => ({ default: LazyErrorFallback }))
);
const StromvergleichKoelnPage = lazy(() =>
  import('@/components/pages/StromvergleichKoelnPage').catch(() => ({ default: LazyErrorFallback }))
);
const StromvergleichEssenPage = lazy(() =>
  import('@/components/pages/StromvergleichEssenPage').catch(() => ({ default: LazyErrorFallback }))
);
const StromvergleichBochumPage = lazy(() =>
  import('@/components/pages/StromvergleichBochumPage').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const StromvergleichDuisburgPage = lazy(() =>
  import('@/components/pages/StromvergleichDuisburgPage').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const StromvergleichWuppertalPage = lazy(() =>
  import('@/components/pages/StromvergleichWuppertalPage').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const StromvergleichBielefeldPage = lazy(() =>
  import('@/components/pages/StromvergleichBielefeldPage').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const StromvergleichBonnPage = lazy(() =>
  import('@/components/pages/StromvergleichBonnPage').catch(() => ({ default: LazyErrorFallback }))
);
const StromvergleichMuensterPage = lazy(() =>
  import('@/components/pages/StromvergleichMuensterPage').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const StromvergleichDuesseldorfPage = lazy(() =>
  import('@/components/pages/StromvergleichDuesseldorfPage').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const StromvergleichDortmundPage = lazy(() =>
  import('@/components/pages/StromvergleichDortmundPage').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const GasvergleichNrwPage = lazy(() =>
  import('@/components/pages/GasvergleichNrwPage').catch(() => ({ default: LazyErrorFallback }))
);
const PhotovoltaikNrwPage = lazy(() =>
  import('@/components/pages/PhotovoltaikNrwPage').catch(() => ({ default: LazyErrorFallback }))
);
const KontaktPage = lazy(() =>
  import('@/components/pages/KontaktPage').catch(() => ({ default: LazyErrorFallback }))
);
const ImpressumPage = lazy(() =>
  import('@/components/pages/ImpressumPage').catch(() => ({ default: LazyErrorFallback }))
);
const DatenschutzPage = lazy(() =>
  import('@/components/pages/DatenschutzPage').catch(() => ({ default: LazyErrorFallback }))
);
const RatgeberPage = lazy(() =>
  import('@/components/pages/RatgeberPage').catch(() => ({ default: LazyErrorFallback }))
);
const StromCategoryPage = lazy(() =>
  import('@/components/pages/ratgeber/StromCategoryPage').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const GasCategoryPage = lazy(() =>
  import('@/components/pages/ratgeber/GasCategoryPage').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const GewerbeCategoryPage = lazy(() =>
  import('@/components/pages/ratgeber/GewerbeCategoryPage').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const PhotovoltaikCategoryPage = lazy(() =>
  import('@/components/pages/ratgeber/PhotovoltaikCategoryPage').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const WechselwissenCategoryPage = lazy(() =>
  import('@/components/pages/ratgeber/WechselwissenCategoryPage').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const StromGrundversorgungArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/StromGrundversorgungArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const StromanbieterwechselnNrwArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/StromanbieterwechselnNrwArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const GrundversorgungVsSondervertragArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/GrundversorgungVsSondervertragArticle').catch(
    () => ({ default: LazyErrorFallback })
  )
);
const SofortSparmoeglichkeitenArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/SofortSparmoeglichkeitenArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const MethodologyPage = lazy(() =>
  import('@/components/pages/MethodologyPage').catch(() => ({ default: LazyErrorFallback }))
);
const NeukndenbonusFallenArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/NeukndenbonusFallenArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const PreiserhoeungWasTunArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/PreiserhoeungWasTunArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const UmzugStromvertragArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/UmzugStromvertragArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const StromtarifVertragslaufzeitArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/StromtarifVertragslaufzeitArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const MaloIdZaehlernummerArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/MaloIdZaehlernummerArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const GasanbieterWechselnNrwArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/GasanbieterWechselnNrwArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const GrundversorgungGasSondervertragArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/GrundversorgungGasSondervertragArticle').catch(
    () => ({ default: LazyErrorFallback })
  )
);
const PreiserhoeungGasRechteArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/PreiserhoeungGasRechteArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const UmzugGasvertragArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/UmzugGasvertragArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const HeizungsartVerbrauchArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/HeizungsartVerbrauchArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const GaspreisgarantieArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/GaspreisgarantieArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const GewerbestromVertragArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/GewerbestromVertragArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const GewerbegasBeschaffungArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/GewerbegasBeschaffungArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const LastprofilLeistungspreisArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/LastprofilLeistungspreisArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const PVKostenNrwArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/PVKostenNrwArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const PVSpeicherArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/PVSpeicherArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const EinspeiseverguetungArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/EinspeiseverguetungArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const DachEignungArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/DachEignungArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const AngeboteVergleichenArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/AngeboteVergleichenArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const KuendigungsfristenArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/KuendigungsfristenArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const LieferantenwechselAblaufArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/LieferantenwechselAblaufArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const WechselSchiefgehtArticle = lazy(() =>
  import('@/components/pages/ratgeber/articles/WechselSchiefgehtArticle').catch(() => ({
    default: LazyErrorFallback,
  }))
);
const ThankYouPage = lazy(() =>
  import('@/components/pages/ThankYouPage').catch(() => ({ default: LazyErrorFallback }))
);
const BlogPage = lazy(() =>
  import('@/components/pages/BlogPage').catch(() => ({ default: LazyErrorFallback }))
);
const BlogDetailPage = lazy(() =>
  import('@/components/pages/BlogDetailPage').catch(() => ({ default: LazyErrorFallback }))
);
const AboutPage = lazy(() =>
  import('@/components/pages/AboutPage').catch(() => ({ default: LazyErrorFallback }))
);
const UeberUnsPage = lazy(() =>
  import('@/components/pages/UeberUnsPage').catch(() => ({ default: LazyErrorFallback }))
);
          ...
          <div className="mx-auto w-full max-w-5xl px-4 pb-12">
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-6">
              ...
              <p className="mt-2 text-sm text-gray-700">
                Interne Verlinkung hilft, die passenden Seiten schneller zu finden – und stärkt die
  ...
  [
    {
      ...
      children: [
        ...
        },
        {
          ...
          element: (
            <Suspense fallback={<LazyFallback />}>
              <StromanbieterwechselnNrwArticle />
            </Suspense>
          ),
          routeMetadata: {
