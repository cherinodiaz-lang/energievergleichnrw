...
export default function TariffCalculatorForm() {
  ...
  const loadRates = useCallback(async () => {
    const validations = [
      ...
      {
        check: validation.isConsumValid,
        message: 'Bitte geben Sie einen gültigen Verbrauch ein (1-50000 kWh).',
      },
    ];
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">Energie-Tarifrechner</h2>
      ...
      {formState.step >= 4 && rates && (
        <div className="mt-8">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-2xl font-bold text-gray-800">Ihre Top-Tarife</h3>
              ...
              >
                <div className="flex justify-between items-start gap-4">
                  <div className="flex-1">
                    ...
                    <h4 className="font-bold text-xl text-gray-900 mb-1">{rate.rateName}</h4>
                    <p className="text-gray-600 font-medium">{rate.providerName}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-3xl font-bold text-green-600">
                      {rate.totalPrice?.toFixed(2)} €
                    </p>
                    <p className="text-sm text-gray-500 font-medium">pro Jahr</p>
                  </div>
                </div>
