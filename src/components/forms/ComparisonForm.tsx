...
export function ComparisonForm({ city, initialValues, onSuccess }: ComparisonFormProps) {
  ...
  const formClasses = useMemo(
    () => ({
      ...
      button:
        'w-full px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors font-medium',
  ...
  return (
    <form
      ...
      aria-label="Energievergleich Formular"
    >
      <div className="mb-4">
      ...
      <div className={formClasses.field}>
        ...
        <input
          ...
          aria-describedby={
            errors.consumption ? 'consumption-error consumption-hint' : 'consumption-hint'
          }
          aria-required="true"
        />
