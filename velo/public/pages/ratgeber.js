...
$w.onReady(async () => {
  try {
    ...
    const cards = [
      {
        title: content.cards.card1Title,
        text: content.cards.card1Text,
        href: content.cards.card1Href,
      },
      {
        title: content.cards.card2Title,
        text: content.cards.card2Text,
        href: content.cards.card2Href,
      },
      {
        title: content.cards.card3Title,
        text: content.cards.card3Text,
        href: content.cards.card3Href,
      },
      {
        title: content.cards.card4Title,
        text: content.cards.card4Text,
        href: content.cards.card4Href,
      },
      {
        title: content.cards.card5Title,
        text: content.cards.card5Text,
        href: content.cards.card5Href,
      },
    ];
